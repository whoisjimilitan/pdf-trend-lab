            ...
            <div className="pg-result">
              ...
              <div className="pg-book-wrap">
                <div className="pg-book" style={{
                  background: "linear-gradient(150deg,#7C3AED 0%,#4F46E5 55%,#3B0764 100%)",
                  boxShadow: "-6px 2px 10px rgba(0,0,0,0.28), 8px 16px 38px rgba(124,58,237,0.42)",
                }}>
                  ...
                  <span className="pg-book-type">Practical Guide</span>
                </div>
              </div>
